...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="<?php echo $this->config->item('upload_url'); ?><?php echo 'assets/logo/'.$this->session->userdata('school_logo'); ?>" type="image/x-icon" />
        <!-- Bootstrap -->
    ...
    <body class="nav-md">      
       ...
       jQuery.extend(jQuery.validator.messages, {
        ...
        $('#name1,#top_title,#main_text,#footer_left,#footer_middle,#footer_right').summernote();
       </script>
