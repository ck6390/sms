                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($assignments) && !empty($assignments)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->deadline)); ?></td>
            ...
            success: function(response){                                                   
               if(response)
               {
                   if(is_edit){
                        ...
                        get_section_by_class('<?php echo $assignment->class_id; ?>', '<?php echo $assignment->section_id; ?>', true);
                   }else{
                        $('#add_subject_id').html(response);
                        get_section_by_class(class_id,'',false);
                   }
               }
            }
        });                  
