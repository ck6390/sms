                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                           <textarea id="name1" name="name" placeholder="<?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('name'); ?>" required="required">
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            <textarea id="top_title" name="top_title" placeholder="<?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('name'); ?>" required="required">
                                               <?php echo isset($top_title) ?  $top_title : ''; ?>
                                            </textarea>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            <textarea id="main_text" name="main_text" placeholder="<?php echo $this->lang->line('main_certificate_text'); ?>" required="required">
                                               <?php echo isset($main_text) ?  $main_text : ''; ?>
                                            </textarea>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <textarea id="footer_left" name="footer_left" placeholder="<?php echo $this->lang->line('footer_left'); ?>" required="required">
                                               <?php echo isset($footer_left) ?  $footer_left : ''; ?>
                                            </textarea>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <textarea id="footer_middle" name="footer_middle" placeholder="<?php echo $this->lang->line('footer_middle'); ?>" required="required">
                                               <?php echo isset($footer_middle) ?  $footer_middle : ''; ?>
                                            </textarea>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <textarea id="footer_right" name="footer_right" placeholder="<?php echo $this->lang->line('footer_right'); ?>" required="required">
                                               <?php echo isset($footer_right) ?  $footer_right : ''; ?>
                                            </textarea>
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <textarea id="name" name="name" placeholder="<?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('name'); ?>" required="required">
                                           <?php echo isset($certificate) ? $certificate->name : $name; ?>
                                           </textarea>
                                             <div class="help-block"><?php echo form_error('name'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <textarea id="top_title" name="top_title" placeholder="<?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('name'); ?>" required="required">
                                                <?php echo isset($certificate) ? $certificate->top_title : $top_title; ?>
                                            </textarea>
                                             <div class="help-block"><?php echo form_error('top_title'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <textarea id="main_text" name="main_text" placeholder="<?php echo $this->lang->line('main_certificate_text'); ?>" required="required">
                                                <?php echo isset($certificate) ? $certificate->main_text : $main_text; ?>
                                            </textarea>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <textarea id="footer_left" name="footer_left" placeholder="<?php echo $this->lang->line('footer_left'); ?>" required="required">
                                                <?php echo isset($certificate) ? $certificate->footer_left : $footer_left; ?>
                                            </textarea>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <!--<input  class="form-control col-md-7 col-xs-12"  name="footer_middle"  id="footer_middle" value="<!-?php echo isset($certificate) ? $certificate->footer_middle : $footer_middle; ?>" placeholder="<!-?php echo $this->lang->line('footer_middle'); ?>" type="text"> -->
                                            ...
                                            <textarea id="footer_middle" name="footer_middle" placeholder="<?php echo $this->lang->line('footer_middle'); ?>" required="required">
                                                <?php echo isset($certificate) ? $certificate->footer_middle : $footer_middle; ?>
                                            </textarea>
                                             <div class="help-block"><?php echo form_error('footer_middle'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                          <!--    <input  class="form-control col-md-7 col-xs-12"  name="footer_right"  id="footer_right" value="<!-?php echo isset($certificate) ? $certificate->footer_right : $footer_right; ?>" placeholder="<!-?php echo $this->lang->line('footer_right'); ?>" type="text"> -->
                                            <textarea id="footer_right" name="footer_right" placeholder="<?php echo $this->lang->line('footer_right'); ?>" required="required">
                                                <?php echo isset($certificate) ? $certificate->footer_right : $footer_right; ?>
                                            </textarea>
                                             <div class="help-block"><?php echo form_error('footer_right'); ?></div>
                                         </div>
                                     </div>
