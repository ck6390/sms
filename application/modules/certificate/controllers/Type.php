...
class Type extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['certificates'] = $this->type->get_list('certificates', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '','', '', 'id', 'ASC'); 
        $this->data['list'] = TRUE;
    ...
    * ********************************************************** */
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_type_data();
                $updated = $this->type->update('certificates', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                $this->data['certificate'] = $this->type->get_single('certificates', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        } else {
            if ($id) {
                $this->data['certificate'] = $this->type->get_single('certificates', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function view($certificate_id = null) {
        ...
        $this->data['settings'] = $this->type->get_single('settings', array('status'=>1,'id'=> $this->session->userdata('school_id')));
        $this->data['certificate'] = $this->type->get_single('certificates', array('id' => $certificate_id,'school_id'=> $this->session->userdata('school_id')));
        $this->data['certificates'] = $this->type->get_list('certificates', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '','', '', 'id', 'ASC'); 
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $certificate = $this->type->get_single('certificates', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        if (!empty($certificate)) {

            // delete employee data
            $this->type->delete('certificates', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));          
