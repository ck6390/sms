...
class Certificate extends MY_Controller {
   ...
   public function __construct() {
        ...
        $this->data['classes'] = $this->type->get_list('classes', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
    }
    ...
    public function generate($student_id, $class_id, $certificate_id){
        ...
        $this->data['certificate']->main_text = get_formatted_certificate_text($this->data['certificate']->main_text, $this->data['student']->role_id.","."Student", $this->data['student']->user_id);
