...
class Event extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['roles'] = $this->event->get_list('roles', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
        $this->data['list'] = TRUE;
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_event_data();
                $updated = $this->event->update('events', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                $this->data['event'] = $this->event->get_single('events', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['event'] = $this->event->get_single('events', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $event = $this->event->get_single('events', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        if ($this->event->delete('events', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
