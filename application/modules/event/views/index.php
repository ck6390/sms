                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    ...
                                    <?php $count = 1; if(isset($events) && !empty($events)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->event_from)); ?></td>

                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->event_to)); ?></td>
                        ...
                        <div class="tab-pane fade in active" id="tab_view_event">
                            ...
                            <div class="x_content"> 
                              ...
                              <?php include 'get-single-event.php'; ?>
