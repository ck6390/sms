                        ...
                        <li class="li-class-list">
                            <select  class="form-control col-md-7 col-xs-12" onchange="get_subject_by_class(this.value);">
                                ...
                                <?php foreach($classes as $obj ){ ?>
                                    <?php if($this->session->userdata('role_id') == 4 && $this->session->userdata('class_id') == $obj->id){ ?>
                                    ...
                                    <?php  $count = 1; if(isset($students) && !empty($students)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($this->session->userdata('role_id') != STUDENT){ ?>
                                                <td>                                                    
                                                    <?php echo $obj->status==1 ? anchor("student/deactivate/".$obj->id."/".base64_encode($obj->email), '<span class="btn btn-danger btn-xs">In-active</span>') : anchor("student/activate/". $obj->id."/".base64_encode($obj->email), '<span class="btn btn-primary btn-xs">Activate</span>');?>
                                                   
													<?php if(has_permission(EDIT, 'student', 'student')){ ?>
                                                        <a href="<?php echo site_url('student/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> </a>
                                                    <?php } ?>
                                                    <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                                    ...
                                                    <?php if(has_permission(DELETE, 'student', 'student')){ ?>
                                                        <a href="<?php echo site_url('student/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> </a>
                                                    <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_student">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('student/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <!--input type="hidden" name="user_type" id="user_type" value="Student" readonly="true"-->
                                <div class="row">                  
                                    <div class="col-md-12 col-sm-12 col-xs-12">
									  ...
									  <div class="col-md-3 col-sm-3 col-xs-12">
                                       <br/>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" value="1" name="is_transport" id="is_transport" checked="true">Transport
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" value="1" name="is_hostel" id="is_hostel" checked="true">Hostel
                                        </label>
                                    </div>
                                </div>
...
<!---Add guardian using by modal-->
                                            <a href="#" data-toggle="modal" data-target="#gaurdian_modal" class="btn btn-success btn-md quick-add">+</a>
                                    ...
                                    <div class="clearfix"></div>
                                     ...
                                     <div class="col-md-2 col-sm-2 col-xs-12" style="padding-top: 4%; padding-left: 4%;">
                                        <a href="javascript:void(0);" class="btn btn-primary" id="copyaddress">Copy</a>
                                     </div>                        
                                     <div class="col-md-5 col-sm-5 col-xs-12">
                                         <div class="item form-group">
                                ...
                                <div class="row">                                      
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <!---Add Class using by modal-->
                                             <a href="javascript:void(0);" data-toggle="modal" data-target="#class_modal" class="btn btn-success btn-md quick-add">+</a>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <!---Add Class using by modal-->
                                             <a href="javascript:void(0);" data-toggle="modal" data-target="#section_modal" class="btn btn-success btn-md quick-add">+</a>
                                         ...
                                         <div class="item form-group">
                                             ...
                                             <select  class="form-control col-md-7 col-xs-12" name="role_id" id="role_id" required="required">
                                                ...
                                                <?php foreach($roles as $obj){ ?>
                                                    <?php if($obj->name == ucfirst($this->router->fetch_class())){ ?>
                               ...
                               <div class="row">                  
                                ...
                                <div class="row">                                     
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label ><?php echo $this->lang->line('student'); ?>  <?php echo $this->lang->line('signature'); ?></label>
                                            <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('signature'); ?>
                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
									 ...
									 <div class="col-md-3 col-sm-3 col-xs-12">
                                       <br/>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" value="1" name="is_transport" id="is_transport" <?= $student->is_transport == 1 ? 'checked':''?>>Transport
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" value="1" name="is_hostel" id="is_hostel" <?= $student->is_transport == 1 ? 'checked':''?>>Hostel
                                        </label>
                                    </div>
                                </div>
                               ...
                               <div class="row">                  
                                ...
                                <div class="row">                  
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="email"  readonly="readonly"  id="email" value="<?php echo isset($student->email) ?  $student->email : ''; ?>" placeholder="<?php echo $this->lang->line('email'); ?>" required="email" type="text">
                                            <div class="help-block"><?php echo form_error('email'); ?></div>
                                         </div>
                                     </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="row">     
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <input type="hidden" name="prev_signature" id="prev_signature" value="<?php echo $student->signature; ?>" />
                                            <?php if($student->signature){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/student-signature/<?php echo $student->signature; ?>" alt="" width="100" /><br/><br/>
                                            <?php } ?>
                                         </div>
                                    </div>   
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
										...
										<input type="hidden" name="user_id" id="user_id" value="<?php echo $student->user_id; ?>" />
                                        <a href="<?php echo site_url('student'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<!-- datatable with buttons -->
 ...
 <script type="text/javascript">
    ...
    $("#copyaddress").click(function() {
        $('#add_permanent_address').val($('#add_present_address').val());
    });
    function get_class(class_id, section_id){ 
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_class'); ?>",
   ...
   function get_section_class(class_id){ 
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_class'); ?>",
            data   : { class_id : class_id},               
            ...
            success: function(response){                                                   
               if(response)
               {
                $('#section_class_id').html(response);
               }
            }
        });  
   }
...
<?php include 'guardian-modal.php'; ?>
<!-----Modal For add class---->
<?php include 'class-modal.php'; ?>
<!-----Modal For add section---->
<?php include 'section-modal.php'; ?>