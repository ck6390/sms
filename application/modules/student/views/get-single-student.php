<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs bordered">
        ...
        <li  class=""><a href="#tab_payment"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-inr"></i> <?php echo $this->lang->line('payment'); ?> </a> </li>                          
    ...
    <div class="tab-content">
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td><?php echo date($this->config->item('date_format'), strtotime($student->admission_date)); ?></td>
                        <th><?php echo $this->lang->line('birth_date'); ?></th>
                        <td><?php echo date($this->config->item('date_format'), strtotime($student->dob)); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->config->item('country_code').$student->phone; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>Student Id</th>
                        <td colspan="3"><?= $student->unique_id; ?></td>
                    </tr>
                </tbody>
            </table>                
        </div>
        <div  class="tab-pane fade in " id="tab_guardian_info" >
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <th><?php echo $this->lang->line('phone'); ?></th>
                        <td><?php echo $this->config->item('country_code').$guardian->phone; ?></td>                        
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->config->item('country_code').$student->father_phone; ?></td>                       
                        <th><?php echo $this->lang->line('mother'); ?> <?php echo $this->lang->line('phone'); ?></th>
                        <td><?php echo $this->config->item('country_code').$student->mother_phone; ?></td>                       
                    </tr>
                    <tr>
        ...
        <div  class="tab-pane fade in table-responsive" id="tab_attendance" >
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <td><?php echo $this->lang->line('date'); ?> <i class="fa fa-long-arrow-right" style="color:#000;"></i>
                            <?php echo $this->lang->line('month'); ?> <i class="fa fa-long-arrow-down" style="color:#000;"></i></td>
        ...
        <div  class="tab-pane fade in " id="tab_payment" style="padding-bottom: 35px;">
            <table id="datatable-responsive-payment" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(has_permission(VIEW, 'accounting', 'invoice')){ ?>
                                    <a target="_blank" href="<?php echo site_url('accounting/invoice/view/'.$obj->custom_invoice_id); ?>" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                <?php } ?>
...
<script type="text/javascript">
    $(document).ready(function() {
      $('#datatable-responsive-payment').DataTable( {
          dom: 'Bfrtip',
          iDisplayLength: 10,
          buttons: [
              'copyHtml5',
