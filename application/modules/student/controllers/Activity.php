...
class Activity extends MY_Controller {
    ...
    public function index($class_id = null) {
        ...
        $this->data['classes'] = $this->activity->get_list('classes', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $student = $this->activity->get_single('students', array('id' => $data['student_id'],'school_id' => $this->session->userdata('school_id')));
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_activity_data();
                $updated = $this->activity->update('student_activities', $data, array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
    ...
    public function delete($id = null) {
        ...
        $activity = $this->activity->get_single('student_activities', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
        if ($this->activity->delete('student_activities', array('id' => $id))) {   
            
            $class = $this->activity->get_single('classes', array('id' => $activity->class_id,'school_id' => $this->session->userdata('school_id')));
