                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo 'Voucher'; ?> <?php echo $this->lang->line('date'); ?></th>
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($expenditures) && !empty($expenditures)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><?php //echo $obj->transaction;?></td> -->
                                            <td><?php echo $obj->payee;?></td>
                                            <td><?php echo $obj->amount;?></td>
                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->date)); ?></td>
                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->created_at)); ?></td>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'accounting', 'expenditure')){ ?>
                                                    ...
                                                    <a class="btn btn-success btn-xs" href="<?php echo site_url('accounting/expenditure/expenditure_print/'.$obj->id); ?>" ><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_expenditure">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accounting/expenditure/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="expenditure_via"  id="expenditure_via" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php $payments = get_payment_expenditure_methods(); ?>
                                 ...
                                 <!-- <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="payee"><?php echo $this->lang->line('transaction'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="transaction"  id="transaction" value="<?php echo isset($post['transaction']) ?  $post['transaction'] : ''; ?>" placeholder="<?php echo $this->lang->line('transaction'); ?>" required="required"  maxlength="40" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('transaction'); ?></div>
                                    </div>
                                </div> -->
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="payee"><?php echo $this->lang->line('payee'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="payee"  id="payee" value="<?php echo isset($post['payee']) ?  $post['payee'] : ''; ?>" placeholder="<?php echo $this->lang->line('payee'); ?>" required="required"  maxlength="80" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note"><?php echo $this->lang->line('remark'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/expenditure/edit/'.$expenditure->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="payee"  id="payee" value="<?php echo isset($expenditure->payee) ?  $expenditure->payee : $post['payee']; ?>" placeholder="<?php echo $this->lang->line('payee'); ?>"  required="required" maxlength="80" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('payee'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
