            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                     <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_fee_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-<?php echo $this->gsms_setting->currency; ?>"></i> <?php echo $this->lang->line('payment'); ?></a> </li>
                     </ul>
                    <br/>
                    <div class="tab-content"> 
                        ...
                        <div class="x_content"> 
                           ...
                           <?php echo form_open(site_url('accounting/payment/paid/'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>                          
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  class="form-control col-md-7 col-xs-12" readonly="readonly" name="amount"  id="amount" value="<?php echo $due_amount; ?>" placeholder="<?php echo $this->lang->line('amount'); ?>" required="required" type="input" step="any" autocomplete="off">
                                    ...
                                    <select  class="form-control col-md-7 col-xs-12"  name="payment_method"  id="payment_method" required="required" onchange="check_payment_method(this.value);">
                                        ...
                                        <?php foreach($payments as $key=>$value ){ ?>
                                            <?php if($this->session->userdata('role_id') == GUARDIAN || $this->session->userdata('role_id') == STUDENT){ ?>
                                                <?php if(in_array($key, array('paypal', 'payumoney', 'ccavenue', 'paytm','atom'))){ ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <?php foreach($invoice_id as $invoice_id){ ?>
                                        <input type="hidden"  class="form-control col-md-7 col-xs-12"  name="invoice_id[]" value="<?php echo $invoice_id; ?>">
                                    <?php }?>
