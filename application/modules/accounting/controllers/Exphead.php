...
class Exphead extends MY_Controller {
    ...
    public function index() {
        ...
        $this->data['expheads'] = $this->exphead->get_list('expenditure_heads', array('status'=> 1,'school_id'=> $this->session->userdata('school_id')));     
        $this->data['list'] = TRUE;
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_exphead_data();
                $updated = $this->exphead->update('expenditure_heads', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['exphead'] = $this->exphead->get_single('expenditure_heads', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['exphead'] = $this->exphead->get_single('expenditure_heads', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
   ...
   {             
    ...
    public function delete($id = null) {
        ...
        $exphead = $this->exphead->get_single('expenditure_heads', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->exphead->delete('expenditure_heads', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) { 
