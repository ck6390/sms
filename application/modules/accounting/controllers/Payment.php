...
class Payment extends My_Controller {
    ...
    public function paid($invoice_id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if($this->input->post('payment_method') == 'cash' || $this->input->post('payment_method') == 'cheque' || $this->input->post('payment_method') == 'account_transfer'){
                    if(!empty($dataList)){ 
    ...
    * ********************************************************** */
    private function _prepare_payment_validation() {
        ...
        }elseif($this->input->post('payment_method') == 'account_transfer'){
        }
