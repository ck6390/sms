...
class Expenditure extends MY_Controller {
    ...
    public function index() {
        ...
        $this->data['expenditure_heads'] = $this->expenditure->get_list('expenditure_heads', array('status'=> 1,'school_id'=> $this->session->userdata('school_id')));        
    ...
    public function edit($id = null) {  
       ...
       check_permission(EDIT);
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_expenditure_data();
                $updated = $this->expenditure->update('expenditures', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['expenditure'] = $this->expenditure->get_single('expenditures', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['expenditure'] = $this->expenditure->get_single('expenditures', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
     ...
     * @return          : null 
     * ********************************************************** */
    public function expenditure_print($id = null){
       $expenditure_id = $id; 
       $this->data['expenditure'] = $this->expenditure->get_single_expenditure($expenditure_id);
       $this->layout->title($this->lang->line('view'). ' ' . $this->lang->line('expenditure'). ' | ' . SMS);
       $this->layout->view('expenditure/expenditure', $this->data); 
    }
    ...
    private function _prepare_expenditure_validation() {
        ...
        $this->form_validation->set_rules('payee', $this->lang->line('payee'), 'trim|required');  
    ...
    public function delete($id = null) {
        ...
        $expenditure = $this->expenditure->get_single('expenditures', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->expenditure->delete('expenditures', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {  
