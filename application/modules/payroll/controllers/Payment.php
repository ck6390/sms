...
class Payment extends MY_Controller {
    ...
    public function index($user_id = null) {
          ...
          //  die();
           ...
           // die();
            ...
            if($user_id){
                ...
                $this->data['user']    = $this->payment->get_single('users', array('id' => $user_id,'school_id'=> $this->session->userdata('school_id'))); 
               
                $payment_to  = $this->data['user']->role_id == 5 ? 'teacher' : 'employee';
        ...
        $this->data['exp_heads'] = $this->payment->get_list('expenditure_heads', array('status'=> 1,'school_id'=> $this->session->userdata('school_id')));
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $user = $this->payment->get_single('users', array('id' => $data['user_id'],'school_id'=> $this->session->userdata('school_id'))); 
    ...
    public function edit($id = null) {  
       ...
       check_permission(EDIT);
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_payment_data();
                $updated = $this->payment->update('salary_payments', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
        ...
        if ($id) {
            ...
            $this->data['edit_payment'] = $this->payment->get_single('salary_payments', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
            ...
            $this->data['expenditure'] = $this->payment->get_single('expenditures', array('id' => $this->data['edit_payment']->expenditure_id,'school_id'=> $this->session->userdata('school_id')));
   ...
   {            
    ...
    private function _get_posted_payment_data() {
        ...
        if ($this->input->post('id')) {
            ...
            $this->payment->update('expenditures', $exp_data, array('id' => $this->input->post('expenditure_id'),'school_id'=> $this->session->userdata('school_id')));
            ...
            $exp_data['school_id']= $this->session->userdata('school_id') ;    
    ...
    public function delete($id = null) {
        ...
        $payment = $this->payment->get_single('salary_payments', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->payment->delete('salary_payments', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {

            $this->payment->delete('expenditures', array('id' => $payment->expenditure_id,'school_id'=> $this->session->userdata('school_id'))); 
            
            $user = $this->payment->get_single('users', array('id' => $payment->user_id,'school_id'=> $this->session->userdata('school_id'))); 
   ...
   /*****************Function get_single_payment**********************************
    ...
    public function view(){
       ...
       $payment_to = $this->uri->segment(5);
       
        $this->data['payment'] = $this->payment->get_single_payment($payment_id, $payment_to);
        $this->data['academic_year_id'] = $this->academic_year_id;
        $this->data['month'] = date('F', strtotime($this->data['payment']->salary_month));
        $this->data['year'] = date('Y', strtotime($this->data['payment']->salary_month));
        $this->data['month_number'] = date('m', strtotime($this->data['month']));
        if ($payment_to == 'employee') {
            $this->data['employees'] = $this->payment->get_list('employees', array('status' => 1,'user_id' => $this->data['payment']->user_id,'school_id'=> $this->session->userdata('school_id')));
        }else{
            $this->data['employees'] = $this->payment->get_list('teachers', array('status' => 1,'user_id' => $this->data['payment']->user_id,'school_id'=> $this->session->userdata('school_id')));
        }
       ...
       $this->data['payment_to'] = $payment_to;   
       $this->data['list'] = TRUE;   
       $this->layout->view('payment/view', $this->data);
    }
