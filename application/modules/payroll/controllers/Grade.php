...
class Grade extends MY_Controller {
    ...
    public function index() {
        ...
        $this->data['grades'] = $this->grade->get_list('salary_grades', array('status'=> 1,'school_id'=> $this->session->userdata('school_id')));     
        $this->data['list'] = TRUE;
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_grade_data();
                $updated = $this->grade->update('salary_grades', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['grade'] = $this->grade->get_single('salary_grades', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['grade'] = $this->grade->get_single('salary_grades', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    public function get_single_grade(){
       ...
       $this->data['grade'] = $this->grade->get_single('salary_grades', array('id' => $grade_id,'school_id'=> $this->session->userdata('school_id')));
   ...
   public function grade_name(){       
    ...
    public function delete($id = null) {
        ...
        $grade = $this->grade->get_single('salary_grades', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->grade->delete('salary_grades', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) { 
