<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-<?php echo $this->gsms_setting->currency; ?>"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('payroll'); ?> <?php echo $this->lang->line('history'); ?></small></h3>
