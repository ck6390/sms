            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                   
                    <ul  class="nav nav-tabs bordered">                          
                        <li  class="<?php echo isset($msgclub) ? 'active':''; ?>"><a href="#tab_msgclub_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('msgclub'); ?> <?php echo $this->lang->line('setting'); ?></a> </li>                   
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in <?php echo isset($msgclub) ? 'active':''; ?>" id="tab_msgclub_setting">
                            <div class="x_content"> 
                                <?php echo form_open_multipart(site_url('setting/sms/msgclub'), array('name' => 'msgclub', 'id' => 'msgclub', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <input type="hidden" value="<?php echo isset($setting) ? $setting->id : ''; ?>" name="id" />
                                <input type="hidden" value="1" name="msgclub" />
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="msgclub_auth_key"><?php echo $this->lang->line('auth_key'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="msgclub_auth_key" value="<?php echo isset($setting) ? $setting->msgclub_auth_key : ''; ?>"  placeholder="<?php echo $this->lang->line('auth_key'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('msgclub_auth_key'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="msgclub_sender_id"><?php echo $this->lang->line('sender_id'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="msgclub_sender_id" value="<?php echo isset($setting) ? $setting->msgclub_sender_id : ''; ?>"  placeholder="<?php echo $this->lang->line('sender_id'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('msgclub_sender_id'); ?></div>
                                    </div>
                                </div> 

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="msgclub_status"><?php echo $this->lang->line('is_active'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="msgclub_status" required="required">
                                            <option value="1" <?php if(isset($setting) && $setting->msgclub_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            <option value="0" <?php if(isset($setting) && $setting->msgclub_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                        </select>
                                        <div class="help-block"><?php echo form_error('msgclub_status'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <a href="http://mysms.filliptechnologies.com" target="_blank"><img src="<?php echo IMG_URL; ?>msglogo.png" alt="" /></a> 
                                    </div>
                                    <div class="col-md-3 text-center">
                                        <?php 
                                            $val = json_decode(check_sms(),true);
											//var_dump($val);
                                            echo "<h3>Available SMS<br/>[".@$val[0]['routeBalance']."]</h3>";
                                        ?>
                                    </div>
                                </div>
