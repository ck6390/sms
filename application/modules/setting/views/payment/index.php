<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-<?php echo $this->gsms_setting->currency; ?>"></i><small> <?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('setting'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    <ul  class="nav nav-tabs bordered">                     
                        ...
                        <li  class="<?php echo isset($ccavenue) ? 'active':''; ?>"><a href="#tab_ccavenue_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('ccavenue'); ?> <?php echo $this->lang->line('setting'); ?></a> </li>                          
                        ...
                        <li  class="<?php echo isset($atom) ? 'active':''; ?>"><a href="#tab_atom_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('atom'); ?> <?php echo $this->lang->line('setting'); ?></a> </li>                          
                    </ul>
                    <br/>
                    <div class="tab-content">
                          ...
                          <div class="tab-pane fade in <?php echo isset($stripe) ? 'active':''; ?> display" id="tab_stripe_setting">
                             <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="stripe_extra_charge" value="<?php echo isset($setting) ? $setting->stripe_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('stripe'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text">
                        ...
                        <div class="tab-pane fade in <?php echo isset($ccavenue) ? 'active':''; ?>" id="tab_ccavenue_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ccavenue_key" value="<?php echo isset($setting) ? $setting->ccavenue_key : ''; ?>"  placeholder="<?php echo $this->lang->line('ccavenue'); ?> <?php echo $this->lang->line('key'); ?>" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ccavenue_salt" value="<?php echo isset($setting) ? $setting->ccavenue_salt : ''; ?>"  placeholder="<?php echo $this->lang->line('ccavenue'); ?> <?php echo $this->lang->line('key_salt'); ?>" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ccavenue_extra_charge"><?php echo $this->lang->line('paytm'); ?> <?php echo $this->lang->line('extra_charge'); ?> (%)</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ccavenue_extra_charge" value="<?php echo isset($setting) ? $setting->ccavenue_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('ccavenue'); ?> <?php echo $this->lang->line('extra_charge'); ?>"  type="text">
                        ...
                        <div class="tab-pane fade in <?php echo isset($atom) ? 'active':''; ?>" id="tab_atom_setting">
                            <div class="x_content"> 
                                <?php echo form_open_multipart(site_url('setting/payment/atom'), array('name' => 'atom', 'id' => 'atom', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <input type="hidden" value="<?php echo isset($setting) ? $setting->id : ''; ?>" name="id" />
                                 <input type="hidden" value="1" name="atom" />
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="atom_user_id"><?php echo $this->lang->line('atom_user_id'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="atom_user_id" value="<?php echo isset($setting) ? $setting->atom_user_id : ''; ?>"  placeholder="<?php echo $this->lang->line('atom_user_id'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('atom_user_id'); ?></div>
                                    </div>
                                </div>                              
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="login_password"><?php echo $this->lang->line('login_password'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="login_password" value="<?php echo isset($setting) ? $setting->login_password : ''; ?>"  placeholder="<?php echo $this->lang->line('login_password'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('login_password'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pro_id"><?php echo $this->lang->line('pro_id'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="pro_id" value="<?php echo isset($setting) ? $setting->pro_id : ''; ?>"  placeholder="<?php echo $this->lang->line('pro_id'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('pro_id'); ?></div>
                                    </div>
                                </div>  
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="request_key"><?php echo $this->lang->line('request_key'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="request_key" value="<?php echo isset($setting) ? $setting->request_key : ''; ?>"  placeholder="<?php echo $this->lang->line('request_key'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('request_key'); ?></div>
                                    </div>
                                </div> 
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="response_key"><?php echo $this->lang->line('response_key'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="response_key" value="<?php echo isset($setting) ? $setting->response_key : ''; ?>"  placeholder="<?php echo $this->lang->line('response_key'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('response_key'); ?></div>
                                    </div>
                                </div> 
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="atom_demo"><?php echo $this->lang->line('is_demo'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="atom_demo" required="required">
                                            <option value="1" <?php if(isset($setting) && $setting->atom_demo == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            <option value="0" <?php if(isset($setting) && $setting->atom_demo == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                        </select>
                                        <div class="help-block"><?php echo form_error('atom_demo'); ?></div>
                                    </div>
                                </div>     
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="atom_status"><?php echo $this->lang->line('is_active'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="atom_status" required="required">
                                            <option value="1" <?php if(isset($setting) && $setting->atom_status == '1'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                            <option value="0" <?php if(isset($setting) && $setting->atom_status == '0'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                        </select>
                                        <div class="help-block"><?php echo form_error('atom_status'); ?></div>
                                    </div>
                                </div>
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">&nbsp;</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <a href="https://www.atomtech.in/" target="_blank"><img src="<?php echo IMG_URL; ?>atomlogo-setting.png" alt="" /> </a> 
                                    </div>
                                </div>
                                <div class="ln_solid"></div>
                                <div class="form-group">
