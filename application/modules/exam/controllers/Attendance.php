...
class Attendance extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->data['classes'] = $this->attendance->get_list('classes', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
        $this->data['exams'] = $this->attendance->get_list('exams', array('status' => 1, 'academic_year_id' => $this->academic_year_id,'school_id' => $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
    }
    ...
    * ********************************************************** */ 
    public function index() {
        ...
        if ($_POST) {
           ...
           $exam = $this->attendance->get_single('exams', array('id'=>$exam_id,'school_id' => $this->session->userdata('school_id')));
           $class = $this->attendance->get_single('classes', array('id'=>$class_id,'school_id' => $this->session->userdata('school_id')));
           $subject = $this->attendance->get_single('subjects', array('id'=>$subject_id,'school_id' => $this->session->userdata('school_id')));
