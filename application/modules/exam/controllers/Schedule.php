...
class Schedule extends MY_Controller {
    ...
    * ********************************************************** */
    public function index($class_id = null) {
        ...
        $this->data['classes'] = $this->schedule->get_list('classes', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
        $this->data['exams'] = $this->schedule->get_list('exams', array('status' => 1, 'academic_year_id' => $this->academic_year_id,'school_id' => $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                     ...
                     $class = $this->schedule->get_single('classes', array('id'=>$data['class_id'],'school_id' => $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_schedule_data();
                $updated = $this->schedule->update('exam_schedules', $data, array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
                ...
                $this->data['post'] = $_POST;
                $this->data['schedule'] = $this->schedule->get_single('exam_schedules', array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['schedule'] = $this->schedule->get_single('exam_schedules', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $exam_schedule = $this->schedule->get_single('exam_schedules', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
        
        if ($this->schedule->delete('exam_schedules', array('id' => $id,'school_id' => $this->session->userdata('school_id')))) {
