...
class Text extends MY_Controller {
        ...
        if (!empty($students)) {
            ...
            foreach ($students AS $obj) {
                ...
                if($get_role_by_id->name == "Student"){
                    ...
                    $user_id = $obj->user_id;
                    $receivers .= $obj->student_name;
                }elseif ($get_role_by_id->name == "Guardian") {                    
                    $guardian = $this->db->get_where('guardians', array('id' => $obj->guardian_id,'school_id' => $this->session->userdata('school_id')))->row();
                    $receiver_mobile = $guardian->phone;
                    $user_id = $guardian->user_id;
                    $receivers .= $guardian->name;
                }
            ...
            // update sms table 
            $this->mark->update('mark_smses', array('receivers' => $receivers), array('id' => $data['sms_id'],'school_id'=> $this->session->userdata('school_id'))); 
        }
    }
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $sms = $this->mark->get_single('mark_smses', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
                
        if ($this->mark->delete('mark_smses', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
