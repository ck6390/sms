...
class Exam extends MY_Controller {
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_exam_data();
                $updated = $this->exam->update('exams', $data, array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
                ...
                $this->data['post'] = $_POST;
                $this->data['exam'] = $this->exam->get_single('exams', array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['exam'] = $this->exam->get_single('exams', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $exam = $this->exam->get_single('exams', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
        
        if ($this->exam->delete('exams', array('id' => $id,'school_id' => $this->session->userdata('school_id')))) {
