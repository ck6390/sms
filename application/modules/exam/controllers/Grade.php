...
class Grade extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['grades'] = $this->grade->get_list('grades', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
        $this->data['list'] = TRUE;
    ...
    * @return          : null 
    ...
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_grade_data();
                $updated = $this->grade->update('grades', $data, array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
                ...
                $this->data['post'] = $_POST;
                $this->data['grade'] = $this->grade->get_single('grades', array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['grade'] = $this->grade->get_single('grades', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $grade = $this->grade->get_single('grades', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
        if ($this->grade->delete('grades', array('id' => $id,'school_id' => $this->session->userdata('school_id')))) {
