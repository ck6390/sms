...
class Finalresult extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->data['classes'] = $this->result->get_list('classes', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
        $this->data['grades'] = $this->result->get_list('grades', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
       // var_dump($this->academic_year_id);
       // die();
        $this->data['exams'] = $this->result->get_list('exams', array('status' => 1, 'academic_year_id'=> $this->academic_year_id,'school_id' => $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
    ...
    * ********************************************************** */
    public function index() {
        ...
        if ($_POST) {
            ...
            $class = $this->result->get_single('classes', array('id'=>$class_id,'school_id' => $this->session->userdata('school_id')));
        ...
        //var_dump($this->gsms_setting);
       // var_dump($final_result_type);
        //die();
        if($this->gsms_setting){
