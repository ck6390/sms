    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div id="dvContainer">
            <div class="x_content">             
                ...
                <div class="row"><br/>
                    <div class="col-md-3 col-30">
                        <?php echo $this->lang->line('name'); ?> : <?php echo $student->name; ?>
                    </div>
                    <div class="col-md-3 col-30">
                        <?php echo $this->lang->line('phone'); ?> : <?php echo $this->config->item('country_code').$student->phone; ?>
                    </div>
                    <div class="col-md-3 col-30">
                        <?php echo $this->lang->line('email'); ?> : <?php echo $student->email; ?>
                    </div>
            ...
            <div class="rowt">
                ...
                <div class="col-xs-2 text-center hiddens">
                    &nbsp;
                </div>
                <div class="col-xs-5 text-center signature right-text">
