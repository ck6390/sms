...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div id="dvContainer">
                        ...
                        <p class="school">
                            <div class="center">
                                <div class="col-xs-12 col-100">
                                    ...
                                    <?php } else{ ?>
                                       <img src="<?php echo IMG_URL; ?>na.png" class="img-thumbnail img-circle logo" width="80px" style="float:left;margin-left:20px;">
                                    <?php } ?>                               
            ...
            <div class="x_content">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap tableclass" cellspacing="0" width="100%" style="border">
                    <thead>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><b><?php echo $_SESSION['running_year'];?></b></td>
                            <td><b>MARKS OBTAINED</b></td>
                        </tr>

                        <tr>
                            <td><b><?php echo $this->lang->line('subject'); ?></b></th>
                            <td style="text-align:center;"><b>Full Marks</b></th>
                    ...
                    <tbody id="fn_mark">   
                        ...
                        if (isset($subjects) && !empty($subjects)) {
                            ...
                            <?php $position = get_position_in_subject($exam_id, $class_id, $section_id, $obj->subject_id , $obj->obtain_total_mark); 
                                ...
                                ?>
                                <tr>
                                    <td><b><?php echo ucfirst($obj->subject); ?></b></td>
                                    <td style="text-align:center;"><?php echo $obj->exam_total_mark; ?></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo !empty($total_marks)?$total_marks: '';?></td>
                            <td style="text-align:center;"><?php echo !empty($obtain_total_marks)?$obtain_total_marks:'';?></td>
                        </tr>
                        <tr>
