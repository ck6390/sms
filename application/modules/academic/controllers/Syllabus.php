...
class Syllabus extends MY_Controller {
    ...
    public function index($class_id = null) {
        ...
        $this->data['classes'] = $this->syllabus->get_list('classes', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_syllabus_data();
                $updated = $this->syllabus->update('syllabuses', $data, array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));

                if ($updated) {
                    
                    $class = $this->syllabus->get_single('classes', array('id' => $data['class_id'],'school_id' => $this->session->userdata('school_id')));
                 ...
                 $this->data['syllabus'] = $this->syllabus->get_single('syllabuses', array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['syllabus'] = $this->syllabus->get_single('syllabuses', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
   ...
   {  
    ...
    public function delete($id = null) {
        ...
        $syllabus = $this->syllabus->get_single('syllabuses', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
        if ($this->syllabus->delete('syllabuses', array('id' => $id))) {   
            
            $class = $this->syllabus->get_single('classes', array('id' => $syllabus->class_id,'school_id' => $this->session->userdata('school_id')));
