...
class Section extends MY_Controller {
    ...
    public function index($class_id = null) {
        ...
        $this->data['classes'] = $this->section->get_list('classes', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
        $this->data['teachers'] = $this->section->get_list('teachers', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
        $this->data['list'] = TRUE;
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $class = $this->section->get_single('classes', array('id' => $data['class_id'],'school_id'=> $this->session->userdata('school_id')));
                    ...
                    if($this->input->post('teacher_id') == 0){
                        echo json_encode(['class_id'=>$this->input->post('class_id'),'section_id'=>$insert_id,'success'=>'Class added successfully']);
                        exit;
                    }
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_section_data();
                $updated = $this->section->update('sections', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['post'] = $_POST;
                 $this->data['section'] = $this->section->get_single('sections', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['section'] = $this->section->get_single('sections', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
   ...
   {             
    ...
    public function delete($id = null) {
        ...
        $section = $this->section->get_single('sections', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        if ($this->section->delete('sections', array('id' => $id))) { 
            
            $class = $this->section->get_single('classes', array('id' => $section->class_id,'school_id'=> $this->session->userdata('school_id')));
