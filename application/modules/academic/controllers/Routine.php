...
class Routine extends MY_Controller {
    ...
    public function index($class_id = null) {
        ...
        $this->data['classes'] = $this->routine->get_list('classes', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
        $this->data['teachers'] = $this->routine->get_list('teachers', array('status' => 1,'school_id' => $this->session->userdata('school_id')), '','', '', 'id', 'ASC');
        
         $this->data['single_class'] = $this->routine->get_single('classes', array('id' => $class_id,'school_id' => $this->session->userdata('school_id')));
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $class = $this->routine->get_single('classes', array('id' => $data['class_id'],'school_id' => $this->session->userdata('school_id')));
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_routine_data();
                $updated = $this->routine->update('routines', $data, array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['routine'] = $this->routine->get_single('routines', array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['routine'] = $this->routine->get_single('routines', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
   ...
   {             
    ...
    public function delete($id = null) {
        ...
        $routine = $this->routine->get_single('routines', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
        
        if ($this->routine->delete('routines', array('id' => $id))) {   
            
            $class = $this->routine->get_single('classes', array('id' => $routine->class_id,'school_id' => $this->session->userdata('school_id')));
