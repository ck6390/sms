                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            ...
                            <table class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <td><?php echo $this->lang->line('date'); ?> <i class="fa fa-long-arrow-right" style="color: #000"></i><br/><?php echo $this->lang->line('month'); ?> <i class="fa fa-long-arrow-down" style="color: #000"></i></td>
                                        <?php 
