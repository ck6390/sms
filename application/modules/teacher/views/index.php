                                    ...
                                    <?php  $count = 1; if(isset($teachers) && !empty($teachers)){ ?>
                                       ...
                                       // var_dump($teachers);
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('d-m-Y',strtotime($obj->dob)); ?></td>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(DELETE, 'teacher', 'teacher')){ ?>
                                                    <a href="<?php echo site_url('teacher/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>  </a>
                                                <?php } ?> 
                                            </td>
                                        </tr>
                                        <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                           <!--  <input type="hidden" name="user_type" id="user_type" value="Teacher" readonly="true"> -->
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="in_time"  id="edit_in_time" value="<?php echo isset($post['in_time']) ?  $post['in_time'] : '10:00 AM'; ?>" placeholder="<?php echo $this->lang->line('in_time'); ?>" type="text">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="out_time"  id="edit_out_time" value="<?php echo isset($post['out_time']) ?  $post['out_time'] : '05:00 PM'; ?>" placeholder="<?php echo $this->lang->line('out_time'); ?>" type="text">
                            ...
                            <?php echo form_open_multipart(site_url('teacher/edit/'. $teacher->id), array('name' => 'editteacher', 'id' => 'editteacher', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="religion"><?php echo $this->lang->line('religion'); ?> </label>
                                             <select class="form-control col-md-7 col-xs-12" name="religion"  id="religion">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="Hinduism" <?php echo ($teacher->religion == "Hinduism") ? 'selected' :''; ?>>Hinduism</option>
                                                <option value="Islam" <?php echo ($teacher->religion == "Islam") ? 'selected' :''; ?>>Islam</option>
                                                <option value="Christianity" <?php echo ($teacher->religion == "Christianity") ? 'selected' :''; ?>>Christianity</option>
                                                <option value="Sikhism" <?php echo ($teacher->religion == "Sikhism") ? 'selected' :''; ?>>Sikhism</option>                                               
                                                <option value="Jainism" <?php echo ($teacher->religion == "Jainism") ? 'selected' :''; ?>>Jainism</option>
                                                <option value="Zoroastrianism" <?php echo ($teacher->religion == "Zoroastrianism") ? 'selected' :''; ?>>Zoroastrianism</option>
                                            </select>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="salary_grade_id" id="salary_grade_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                <?php foreach($grades as $obj){ ?>                                           
                                                <option value="<?php echo $obj->id; ?>" <?php if($teacher->salary_grade_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->grade_name.' -['.$obj->net_salary.']'; ?></option>
                                                <?php } ?>           
                                            </select>
                                            <a href="<?php echo site_url('payroll/grade/add'); ?>" class="btn btn-success btn-md quick-add">+</a>
                                            <div class="help-block"><?php echo form_error('salary_grade_id'); ?></div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="role_id" id="role_id" required="required">
                                                ...
                                                <?php foreach($roles as $obj){ ?>
                                                   <?php if($obj->name == ucfirst($this->router->fetch_class())){ ?>
                                                    <option value="<?php echo $obj->id.",".$obj->name; ?>" <?php if($teacher->role_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->name; ?></option>
                                                    <?php } ?>
                                                <?php } ?>                                              
                                            </select>
                                            <a href="<?php echo site_url('administrator/role/add'); ?>" class="btn btn-success btn-md quick-add">+</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="facebook_url"><?php echo $this->lang->line('in_time'); ?> <span class="required">*</span> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="in_time"  id="in_time" value="<?php echo isset($teacher->in_time) ?  $teacher->in_time : ''; ?>" placeholder="<?php echo $this->lang->line('in_time'); ?>" type="text">
                                            <div class="help-block"><?php echo form_error('in_time'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="facebook_url"><?php echo $this->lang->line('out_time'); ?> <span class="required">*</span> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="out_time"  id="out_time" value="<?php echo isset($teacher->out_time) ?  $teacher->out_time : ''; ?>" placeholder="<?php echo $this->lang->line('out_time'); ?>" type="text">
                                            <div class="help-block"><?php echo form_error('out_time'); ?></div>
                                        </div>
                                    </div>
