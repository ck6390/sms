...
class Designation extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['designations'] = $this->designation->get_list('designations', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '','', '', 'id', 'ASC'); 
        $this->data['list'] = TRUE;
    ...
    * ********************************************************** */
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_designation_data();
                $updated = $this->designation->update('designations', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                $this->data['designation'] = $this->designation->get_single('designations', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        } else {
            if ($id) {
                $this->data['designation'] = $this->designation->get_single('designations', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $designation = $this->designation->get_single('designations', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->designation->delete('designations', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) { 
