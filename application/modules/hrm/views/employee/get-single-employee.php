            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        ...
                        <th>Unique Id</th>
                        <td><?php echo $employee->unique_id; ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('designation'); ?></th>
                        <td><?php echo $employee->designation; ?></td>        
                        <th><?php echo $this->lang->line('phone'); ?></th>
                        <td><?php echo $this->config->item('country_code').$employee->phone; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo date($this->config->item('date_format'), strtotime($employee->dob)); ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('join_date'); ?></th>
                        <td><?php echo date($this->config->item('date_format'), strtotime($employee->joining_date)); ?></td>        
