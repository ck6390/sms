...
class Issue extends MY_Controller {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    $book = $this->book->get_single('books', array('id' => $data['book_id'],'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function get_book_by_id() {
        ...
        $book = $this->book->get_single('books', array('id' => $book_id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function return_book_by_id() {
        ...
        $this->book->update('book_issues', array('is_returned' => 1, 'return_date' => $return_date), array('id' => $issue_id,'school_id'=> $this->session->userdata('school_id')));
