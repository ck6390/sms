...
class Book extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['books'] = $this->book->get_list('books', array('status' => 1,'school_id'=> $this->session->userdata('school_id')));
        $this->data['roles'] = $this->book->get_list('roles', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_book_data();
                $updated = $this->book->update('books', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                $this->data['book'] = $this->book->get_single('books', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['book'] = $this->book->get_single('books', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    ...
    public function get_single_book(){
       ...
       $book_id = $this->input->post('book_id');
        ...
        $this->data['book'] = $this->book->get_single('books', array('id' => $book_id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $book = $this->book->get_single('books', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        if ($this->book->delete('books', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
