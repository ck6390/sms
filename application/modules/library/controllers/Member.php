...
class Member extends MY_Controller {
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $member = $this->book->get_single('library_members', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        if ($this->book->delete('library_members', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
            $this->book->update('students', array('is_library_member' => 0), array('user_id' => $member->user_id,'school_id'=> $this->session->userdata('school_id')));
            
            $student = $this->book->get_single('students', array('user_id' => $member->user_id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function add_to_library() {
        ...
        if ($user_id) {
            ...
            $member = $this->book->get_single('library_members', array('user_id' => $user_id,'school_id'=> $this->session->userdata('school_id')));
            if (empty($member)) {
                ...
                $this->book->update('students', array('is_library_member' => 1), array('user_id' => $user_id,'school_id'=> $this->session->userdata('school_id')));
