...
Class Hostel extends MY_Controller {
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_hostel_data();
                $updated = $this->hostel->update('hostels', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                $this->data['hostel'] = $this->hostel->get_single('hostels', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['hostel'] = $this->hostel->get_single('hostels', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $hostel = $this->hostel->get_single('hostels', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->hostel->delete('hostels', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
