...
<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs bordered">
        ...
        <li class=""><a href="#tab_invoice_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-<?php echo $this->gsms_setting->currency; ?>"></i> <?php echo $this->lang->line('invoice'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
    </ul>
    <br/>
        ...
        <div  class="tab-pane fade in active" id="tab_guardian" >    
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <th>Unique Id</th>
                        <td><?php echo $guardian->unique_id; ?></td>
                    </tr>
                    <tr>
