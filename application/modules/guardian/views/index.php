                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($guardians) && !empty($guardians)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->status==1 ? anchor("guardian/deactivate/".$obj->id."/".base64_encode($obj->email), '<span class="btn btn-success btn-xs">In-active</span>') : anchor("guardian/activate/". $obj->id."/".base64_encode($obj->email), '<span class="btn btn-danger btn-xs">Activate</span>');?></td>
                                            <td>
                            ...
                            <?php echo form_open_multipart(site_url('guardian/edit/'. $guardian->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="email" id="email" value="<?php echo isset($guardian->email) ?  $guardian->email : ''; ?>" placeholder="<?php echo $this->lang->line('email'); ?>" required="email" type="email">
                                            <div class="help-block"><?php echo form_error('email'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <input type="hidden" name="uid" id="uid" value="<?php echo $guardian->uid; ?>" />
                                        <a href="<?php echo site_url('guardian'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
