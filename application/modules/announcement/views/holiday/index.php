                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($holidays) && !empty($holidays)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->date_from)); ?></td>
                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->date_to)); ?></td>
                                            <td>
                        ...
                        <div class="tab-pane fade in active" id="tab_view_holiday">
                            <div class="x_content"> 
                              <?php include 'get-single-holiday.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
