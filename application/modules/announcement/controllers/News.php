...
class News extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
         ...
         $this->data['news_list'] = $this->news->get_list('news', array('status'=>1,'school_id'=> $this->session->userdata('school_id')), '','', '', 'id', 'DESC');  
        $this->data['list'] = TRUE;
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['news_list'] = $this->news->get_list('news', array('status'=>1,'school_id'=> $this->session->userdata('school_id')));  
        $this->data['add'] = TRUE;
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($updated) {
                 ...
                 $this->data['news'] = $this->news->get_single('news', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['news'] = $this->news->get_single('news', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    ...
    public function get_single_news(){
       ...
       $this->data['news'] = $this->news->get_single('news', array('id' => $news_id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    ...
    public function delete($id = null) {
        ...
        if(!is_numeric($id)){
         ...
         $news = $this->news->get_single('news', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        if ($this->news->delete('news', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {  
