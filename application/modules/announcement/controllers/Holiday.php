...
class Holiday extends MY_Controller {
    ...
    * ********************************************************** */ 
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_holiday_data();
                $updated = $this->holiday->update('holidays', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['holiday'] = $this->holiday->get_single('holidays', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['holiday'] = $this->holiday->get_single('holidays', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    ...
    public function get_single_holiday(){
       ...
       $this->data['holiday'] = $this->holiday->get_single('holidays', array('id' => $holiday_id,'school_id'=> $this->session->userdata('school_id')));
      // var_dump($this->data['holiday']);
        //die();
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $holiday = $this->holiday->get_single('holidays', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->holiday->delete('holidays', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) { 
