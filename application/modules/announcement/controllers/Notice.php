...
class Notice extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['roles'] = $this->notice->get_list('roles', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_notice_data();
                $updated = $this->notice->update('notices', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                $this->data['notice'] = $this->notice->get_single('notices', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['notice'] = $this->notice->get_single('notices', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $notice = $this->notice->get_single('notices', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->notice->delete('notices', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
