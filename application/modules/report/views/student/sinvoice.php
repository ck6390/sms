                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            ...
                            <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    ...
                                    $count = 1; if(isset($sbalance) && !empty($sbalance)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <th class="green total_collection"><?php echo $obj->paid_amount ? $obj->paid_amount : 0; ?></th>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5" class="text-right green right-text"><b>Total Collection</b></td>
                                        <th class="green"></th>
                                    </tr>
                                </tfoot>
                            </table>
...
<script src="<?php echo VENDOR_URL; ?>datepicker/datepicker.js"></script>
 ...
 <script>
        ...
        function calculateColumn(index) {
            ...
            $('table tfoot th').eq(index).text(total+'.00');
        }
    </script>
