                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            ...
                            <table class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('date'); ?> <i class="fa fa-long-arrow-right" style="color: #000;"></i><br/><?php echo $this->lang->line('month'); ?> <i class="fa fa-long-arrow-down" style="color: #000"></i></th>
                                        <?php 
                                ...
                                <tbody>   
                                    ...
                                    <?php foreach($months as $key=>$value){ ?>
                                        <?php 
											...
											$all_sun = getSundays($month_number);
                                           ?>
                                        <?php if(!empty($attendance)){ ?>
                                         <tr>
                                             <td><?php echo $value; ?></td> 
                                             <?php $attendance_data = json_decode($attendance->attendance_data); 
                                             if(is_array($attendance_data)){
                                                foreach($attendance_data AS $key ){ ?>
                                                <td> 
