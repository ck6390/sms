...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('accountant'); ?> <?php //echo $this->lang->line('balance'); ?> <?php echo $this->lang->line('report'); ?></small></h3>                
            ...
            <?php $this->load->view('quick_report'); ?>   
             ...
             <div class="x_content filter-box no-print"> 
                <?php echo form_open_multipart(site_url('report/accountant'), array('name' => 'balance', 'id' => 'balance', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">                    
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="item form-group"> 
                            <?php echo $this->lang->line('accountant'); ?> <span class="required">*</span>
                            <select  class="form-control col-md-7 col-xs-12" name="user_id" id="user_id"  required="required">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                <?php foreach ($accountants as $key=>$accountant) { ?>
                                <option value="<?php echo $accountant->user_id; ?>" <?php if(isset($user_id) && $user_id == $accountant->user_id){ echo 'selected="selected"';} ?>><?php echo $accountant->name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
            ...
            <div class="x_content" id="dvContainer">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered no-print hiddens">
                        ...
                        <!-- <li  class=""><a href="#tab_graphical"   role="tab" data-toggle="tab"  aria-expanded="false"><i class="fa fa-line-chart"></i> <?php echo $this->lang->line('graphical'); ?> <?php echo $this->lang->line('report'); ?></a> </li>  -->                         
                    </ul>
                    <br/>
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in" id="tab_graphical" >
                            <div class="x_content">
