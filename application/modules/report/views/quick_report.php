    ...
    <div class="row">                   
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <select  class="form-control" name="report" id="report" onchange="get_report_action(this.value);">
                    ...
                    $reports[site_url('report/accountant')] = $this->lang->line('accountant') .' ' . $this->lang->line('report'); 
                    ...
                    <option value="<?php echo $key; ?>" <?php if(isset($action) && $action == $key){ echo 'selected="selected"';} ?>><?php echo $value; ?></option>
                    <?php } ?>
                </select>
        </div>
    </div>             
