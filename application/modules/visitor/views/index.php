                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($visitors) && !empty($visitors)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php 
                                            $user = get_user_by_role($obj->role_id, $obj->user_id); echo @$user->name; ?><br/>(<?php echo $obj->role; ?>)</td>
                                            <td><?php echo $this->lang->line($obj->reason); ?></td>                                           
                                            <td><?php echo date($this->config->item('date_format'). ' h:i:s A', strtotime($obj->check_in)); ?></td>                                           
                                            <td><?php echo $obj->check_out ? date($this->config->item('date_format') . ' H:i:s A', strtotime($obj->check_out)) : '<a style="color:red;" href="javascript:void(0);" onclick="check_out('.$obj->id.');">'.$this->lang->line('check_out').'</a>'; ?></td>                                           
                                            <td>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value, '<?php echo $visitor->user_id; ?>');">
                                            ...
                                            <?php foreach($roles as $obj ){ ?>
                                                <?php if($obj->name != "Guardian"){ ?>
                                                <option value="<?php echo $obj->id.",".$obj->name; ?>" <?php
                                                 $role = explode(",", $visitor->role_id);
                                                 if($role[0] == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->name; ?></option>
                                                <?php } ?>                                            
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('role_id'); ?></div>
