<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo date($this->config->item('date_format'). ' h:i:s A', strtotime($visitor->check_in)); ?></td>
        </tr>        
        <tr>
            <th><?php echo $this->lang->line('check_out'); ?></th>
            <td><?php echo $visitor->check_out ? date($this->config->item('date_format') . ' H:i:s A', strtotime($visitor->check_out)) : '<a style="color:red;" href="javascript:void(0);" onclick="check_out('.$visitor->id.');">'.$this->lang->line('check_out').'</a>'; ?></td>
        </tr>        
        <tr>
