...
class Visitor extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->data['roles'] = $this->visitor->get_list('roles', array('status' => 1,'school_id'=> $this->session->userdata('school_id')), '', '', '', 'id', 'ASC');
    }
    ...
    * ********************************************************** */
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_visitor_data();
                $updated = $this->visitor->update('visitors', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                $this->data['post'] = $_POST;
                $this->data['visitor'] = $this->visitor->get_single('visitors', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }

        if ($id) {
            $this->data['visitor'] = $this->visitor->get_single('visitors', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
    ...
    * ********************************************************** */
    public function delete($id = null) {
        ...
        $visitor = $this->visitor->get_single('visitors', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->visitor->delete('visitors', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
    ...
    * ********************************************************** */
    public function visitor_check_out() {
        ...
        if($this->visitor->update('visitors', $data, array('id' => $visitor_id,'school_id'=> $this->session->userdata('school_id')))){
            echo TRUE;
        }else{
            echo FALSE;  
        }
