...
class Year extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['years'] = $this->year->get_list('academic_years', array('status' => 1,'school_id' => $this->session->userdata('school_id')),'','', '', 'id', 'ASC');
        //var_dump($this->data);
        //die();
        $this->data['list'] = TRUE;
    ...
    * ********************************************************** */
    public function edit($id = null) {   
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_year_data();
                $updated = $this->year->update('academic_years', $data, array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['year'] = $this->year->get_single('academic_years', array('id' => $this->input->post('id'),'school_id' => $this->session->userdata('school_id')));
            }
        } else {
            if ($id) {
                $this->data['year'] = $this->year->get_single('academic_years', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
   ...
   * ********************************************************** */
    public function delete($id = null) {
        ...
        $academic_year = $this->year->get_single('academic_years', array('id' => $id,'school_id' => $this->session->userdata('school_id')));
