                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" value="<?php echo isset($role) ? $role->id : ''; ?>" name="id" />
                                         <select class="form-control" id="name" name="name">
                                            <option value="">===Select Role===</option>
                                            <option value="Admin" <?php echo $role->name == "Admin" ? 'selected' : ''; ?> >Admin</option>
                                            <option value="Guardian" <?php echo $role->name == "Guardian" ? 'selected' : ''; ?>>Guardian</option>
                                            <option value="Student" <?php echo $role->name == "Student" ? 'selected' : ''; ?>>Student</option>
                                            <option value="Teacher" <?php echo $role->name == "Teacher" ? 'selected' : ''; ?>>Teacher</option>
                                            <option value="Accountant" <?php echo $role->name == "Accountant" ? 'selected' : ''; ?>>Accountant</option>
                                            <option value="Librarian" <?php echo $role->name == "Librarian" ? 'selected' : ''; ?>>Librarian</option>
                                            <option value="Receptionist" <?php echo $role->name == "Receptionist" ? 'selected' : ''; ?>>Receptionist</option>
                                            <option value="Staff" <?php echo $role->name == "Staff" ? 'selected' : ''; ?>>Staff</option>
                                        </select>
