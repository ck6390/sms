                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php
                                     ...
                                     $count = 1; if(isset($roles) && !empty($roles)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'administrator', 'permission')){ ?>  
                                                    <a href="<?php echo site_url('administrator/permission/index/'.$obj->role_id); ?>" class="btn btn-success btn-xs"><i class="fa fa-folder-open-o"></i> <?php echo $this->lang->line('role_permission'); ?> <?php echo $this->lang->line('setting'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <?php if(has_permission(EDIT, 'administrator', 'permission')){ ?>  
                                            ...
                                            <button  type="button" disabled="disabled" class="btn btn-success hidden"><?php echo $this->lang->line('update'); ?> <?php echo $this->lang->line('role_permission'); ?></button>
