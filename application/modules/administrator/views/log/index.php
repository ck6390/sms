                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12"  name="role_id"  id="role_id" onchange="get_user_by_role(this.value, '', '');" required="true">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-12 col-xs-12"  name="user_id"  id="user_id" required="true">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                            </select>
                                    ...
                                    if (isset($activity_logs) && !empty($activity_logs)) {
                                        ...
                                        <?php foreach ($activity_logs as $obj) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $obj->activity; ?> at <?php echo date($this->config->item('date_format').' H:i:s a', strtotime($obj->created_at)); ?></td>   
                                                <td>                                                 
