                                    ...
                                    <?php $count = 1; if(isset($galleries) && !empty($galleries)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(EDIT, 'gallery', 'gallery')){ ?>
                                                    <a  onclick="get_gallery_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-gallery-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                <?php  } ?>    
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo $this->lang->line('gallery'); ?> <?php echo $this->lang->line('information'); ?></h4>
        </div>
        <div class="modal-body fn_gallery_data">
...
<script type="text/javascript">
    ...
    function get_gallery_modal(gallery_id){
         
        $('.fn_gallery_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('gallery/get_single_gallery'); ?>",
          data   : {gallery_id : gallery_id},  
          success: function(response){                                                   
             if(response)
             {
                $('.fn_gallery_data').html(response);
             }
          }
       });
    }
