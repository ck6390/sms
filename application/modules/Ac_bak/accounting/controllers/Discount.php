...
class Discount extends MY_Controller {
    ...
    public function index() {
        ...
        $this->data['discounts'] = $this->discount->get_list('discounts', array('status'=> 1,'school_id'=> $this->session->userdata('school_id')), '', '', '', 'id', 'DESC');  
        $this->data['list'] = TRUE;
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_discount_data();
                $updated = $this->discount->update('discounts', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['discount'] = $this->discount->get_single('discounts', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['discount'] = $this->discount->get_single('discounts', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
   ...
   {             
    ...
    public function delete($id = null) {
        ...
        $discount = $this->discount->get_single('discounts', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->discount->delete('discounts', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) {
