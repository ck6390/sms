...
class Incomehead extends MY_Controller {
    ...
    public function index() {
        ...
        $this->data['incomeheads'] = $this->incomehead->get_list('income_heads', array('status'=> 1, 'head_type'=>'income','school_id'=> $this->session->userdata('school_id')), '', '', '', '', '');  
        $this->data['list'] = TRUE;
    ...
    public function edit($id = null) {       
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_incomehead_data();
                $updated = $this->incomehead->update('income_heads', $data, array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
                ...
                if ($updated) {
                 ...
                 $this->data['incomehead'] = $this->incomehead->get_single('income_heads', array('id' => $this->input->post('id'),'school_id'=> $this->session->userdata('school_id')));
            }
        }
        
        if ($id) {
            $this->data['incomehead'] = $this->incomehead->get_single('income_heads', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
   ...
   {             
    ...
    public function delete($id = null) {
        ...
        $income_head = $this->incomehead->get_single('income_heads', array('id' => $id,'school_id'=> $this->session->userdata('school_id')));
        
        if ($this->incomehead->delete('income_heads', array('id' => $id,'school_id'=> $this->session->userdata('school_id')))) { 
