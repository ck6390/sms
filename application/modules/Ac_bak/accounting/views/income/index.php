                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($incomes) && !empty($incomes)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->config->item('date_format'), strtotime($obj->date)); ?></td>
                                            ...
                                            <td>
                                                <?php if(has_permission(VIEW, 'accounting', 'income')){ ?>
                                                    ...
                                                    <a href="<?php echo site_url('accounting/income/detail/'.$obj->id); ?>" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_income">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accounting/income/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="income_head_id"> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="radio" name="usertype" value="existing" <?php if(isset($post) && $post['usertype'] == 'existing'){ echo 'checked';}
                                            elseif (empty($post['usertype'])) {
                                                echo 'checked';
                                            }?>> 
                                        Existing Student
                                        <input type="radio" name="usertype" value="nonexisting" <?php if(isset($post) && $post['usertype'] == 'nonexisting'){ echo 'checked';}?>> Non Existing Student
                                    </div>
                                </div>
                                ...
                                <div class="item form-group existing displaynone" style="<?php if(isset($post) && $post['usertype'] == 'existing' || empty($post['usertype'])){ echo 'display:block;';} else{ echo 'display:none;'; } ?>">
                                ...
                                <!--  Start For non exiting student-->
                                <div class="nonexisting displaynone" style="<?php if(isset($post) && $post['usertype'] == 'nonexisting'){ echo 'display:block;';} else{ echo 'display:none;'; } ?>">
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="student_name"> <?php echo $this->lang->line('name'); ?><span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="add_student_name"  id="add_student_name" value="<?php echo isset($post['add_student_name']) ?  $post['add_student_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('name'); ?>"  type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('add_student_name'); ?></div>
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="student_name"> <?php echo $this->lang->line('phone'); ?><span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="add_student_phone"  id="add_student_phone" value="<?php echo isset($post['add_student_phone']) ?  $post['add_student_phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" maxlength="15" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('add_student_phone'); ?></div>
                                        </div>
                                    </div> 

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="student_name"> <?php echo $this->lang->line('email'); ?><span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="add_student_email"  id="add_student_email" value="<?php echo isset($post['add_student_email']) ?  $post['add_student_email'] : ''; ?>" placeholder="<?php echo $this->lang->line('email'); ?>"  type="email" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('add_student_email'); ?></div>
                                        </div>
                                    </div>  
                                </div>
                                <!-- End For non exiting student -->
                                ...
                                <div class="item form-group">
                                 ...
                                 <!-- For cheque Start-->
                                <div class="display fn_add_cheque" style="<?php if(isset($post) && $post['payment_method'] == 'cheque'){ echo 'display:block;'; }else{ echo 'display:none;'; } ?>">
                                <div class="item form-group">
                            ...
                            <!-- For cheque End-->
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="date"  id="add_date" value="<?php echo isset($post['date']) ?  $post['date'] : date('d-m-Y'); ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
