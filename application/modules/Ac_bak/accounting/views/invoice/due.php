                                       ...
                                       <?php $count = 1; if(isset($invoices) && !empty($invoices)){ ?>
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                   ...
                                                   <a href="<?php echo site_url('accounting/invoice/view/'.$obj->custom_invoice_id); ?>"  class="btn btn-success btn-xs"><i class="fa fa-credit-card"></i> <?php echo $this->lang->line('payment'); ?> </a>
