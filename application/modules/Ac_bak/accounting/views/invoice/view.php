                ...
                <section class="content invoice profile_img text-left">
                        ...
                        <div class="row invoice-info">
                            <div class="col-sm-4 invoice-header  invoice-col col-33">
                                <h1><?php echo $this->lang->line('fee_receipt'); ?></h1>
                            </div>
                        ...
                        <div class="row invoice-info">
                            <div class="col-sm-4 invoice-col col-33">
                                <strong><?php echo $this->lang->line('school'); ?>:</strong>
                                    ...
                                    <br><strong><?php echo $this->lang->line('phone'); ?>:</strong> <?php echo $this->gsms_setting->phone; ?>
                                    <br><strong><?php echo $this->lang->line('email'); ?>:</strong> <?php echo $this->gsms_setting->email; ?>
                            ...
                            <div class="col-sm-4 invoice-col col-33">
                                ...
                                <?php echo $invoice->present_address; ?>
                            ...
                            <!-- /.col -->
                            <div class="col-sm-4 invoice-col col-33 right-text">
			...
			<div class="col-50 hidden margin-left">
                <section class="content invoice profile_img text-left">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-header  invoice-col col-33"><h1 class="hidden">Student Copy</h1></div>
                            <div class="col-sm-4 invoice-header  invoice-col col-33 right-text">
                                <?php if($this->session->userdata('school_logo')){?>               
                                    <img class="img-thumbnail img-circle logo" src="<?php echo $this->config->item('upload_url'); ?><?php echo 'assets/logo/'.$this->session->userdata('school_logo'); ?>" alt="" width="80" />
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col col-33 right-text">
                                ...
                                <br>
                                <b><?php $btn_class = get_paid_status($invoice->payment_status) == "Paid" ? 'success' : 'danger';
                                echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('status'); ?>:</b> <span class="btn-<?= $btn_class ?>"><?php echo get_paid_status($invoice->payment_status); ?></span>
                                <br>
                                <b><?php echo $this->lang->line('date'); ?>:</b> <?php echo date($this->config->item('date_format'), strtotime($invoice->created_at)); ?>
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="col-xs-12 table">
                            <table class="table table-striped">
                                ...
                                ?>
                                    <tr>
                                        <td class="border-top"><br/><?php echo $i; ?>
                                            <input name="inv_ids[]" class="hiddens" data-amount="<?php echo $invoiceData->net_amount; ?>" <?php echo ($invoiceData->paid_status == 'paid')? 'disabled' : ''; ?>  value="<?php echo $invoiceData->inv_id; ?>" <?php echo ($invoiceData->paid_status == 'paid')? '' : 'checked="checked"'; ?> type="checkbox">
                                        </td>
                                        <td class="border-top"><br/>                                        
                                        <?php 
                                            $btn_class = $invoiceData->paid_status == "paid" ? "success" : "danger";
