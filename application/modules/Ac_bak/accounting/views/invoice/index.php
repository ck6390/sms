                                            ...
                                            <div class="item form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <?php foreach($monthsArray as $key=>$months ){ ?>
                                                        ...
                                                        <input  name="month[]" class="month" value="<?php echo date('m',strtotime($key))?>" <?php echo $this->lang->line('month'); ?>" required="required" type="checkbox"> <?php echo $months; ?>                                                        
                                                        </li>
                                                    <?php } ?> 
...
<script type="text/javascript"> 
            ...
            var html = '';                                                
               ...
               {  
                $.each(response, function(index, el) {
                    html += '<li style="list-style-type: none;"><input  name="income_head_id[]" class="income_head '+el.title+'" data-amount="'+el.fee_amount+'" value='+el.id+'" <?php echo $this->lang->line('amount'); ?>" required="required" type="checkbox"> '+el.title+' <span>( <i class="fa fa-inr" style="color:#000;"></i> '+el.fee_amount+')</span></li>';
                    });
                    ...
                    $('#fee_type').html('<li style="list-style-type: none;">Please create some fee type for this class</li>'); 
               }
            }
        });
   }
 ...
 <script type="text/javascript">
        $(document).ready(function() {
            $('.Transport').find( "span" ).html('asdfasfasf asfda');
